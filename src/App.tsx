  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark transition-colors duration-200">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        isScrolled ? 'bg-white dark:bg-dark shadow-md dark:shadow-gray-800' : 'bg-transparent'
      }`}>
          ...
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <motion.a
                ...
                className="px-6 py-3 rounded-full bg-primary text-white hover:bg-primary-dark transition-colors"
                whileHover={{ scale: 1.05 }}
              >
                Resume
              </motion.a>
